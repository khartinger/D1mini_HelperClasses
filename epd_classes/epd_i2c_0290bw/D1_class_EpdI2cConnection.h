//_____D1_class_EpdI2cConnection.h_______________180510-180510_____
...
//  int cs_pin;
 ...
 public:
  EpdI2cConnection();
  EpdI2cConnection(int epdBusyLevel);            // NEW 180508
/*  
    EpdI2cConnection(int busyPin, int resetPin,
                int dcPin, int csPin);
  EpdI2cConnection(int busyPin, int resetPin,
